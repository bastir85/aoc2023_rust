...
fn main(){
    ...
    const TEXT: &str = "Game 1: 2 blue, 3 red; 3 green, 3 blue, 6 red; 4 blue, 6 red; 2 green, 2 blue, 9 red; 2 red, 4 blue
...
const TEXT2 : &str ="Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green";
    //let max_runes = Game{red:12, green:14, blue:14};
    let max_runes = Game{red:12, green:13, blue:14};
        ...
        let (name, rounds) =  line.split_once(':').unwrap();
            ...
            for round in rounds.split(';'){
                for color in round.split(','){
                    ...
                    let set_c = | color: &mut u8| {
                        *color = max(*color, num);
                    };
                    match color.trim() {
                        "red" => set_c(&mut total.red),
                        "green" => set_c(&mut total.green),
                        "blue" => set_c(&mut total.blue),
                        &_ => assert!(true, "Error!")
                    }
                }
            }
            let a = total.red as u16 * total.green as u16* total.blue as u16;
            println!("{index} valid {0} {1} {2} -> {3}", total.red, total.green, total.blue, a);
            answer2 += a;
    ...
    println!("Answer: {answer} Answer2 {answer2}");
